...
namespace MyListing\ACF\Code_Field;
...
class Code_Field extends \acf_field {
	...
	function __construct() {
		...
		$this->config['dir'] = trailingslashit( CASE27_INTEGRATIONS_DIR ) . 'advanced-custom-fields/acf-code-field/';
		$this->config['uri'] = trailingslashit( get_template_directory_uri() ) . 'includes/integrations/advanced-custom-fields/acf-code-field/';
	...
	function render_field( $field ) {
        $dir = trailingslashit( get_template_directory_uri() ) . 'includes/integrations/advanced-custom-fields/acf-code-field/';
		...
		echo $e;
		wp_enqueue_style( "codemirror-curr-style-{$field['theme']}", "{$dir}js/" . $this->config['codemirror_version'] . "/theme/{$field['theme']}.css" );
	}

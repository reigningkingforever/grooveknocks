...
class WooCommerce {
	...
	public function __construct() {
		...
		// Wrap user dashboard templates in a block layout.
		mylisting()->woocommerce()->wrap_page_in_block( [
			'start' => 'mylisting/promotions/templates/dashboard/before',
			'end' => 'mylisting/promotions/templates/dashboard/after',
			'title' => _x( 'Active Promotions', 'User dashboard > Promotions > Page Title', 'my-listing' ),
			'icon' => 'icon-flash',
		] );
	...
	public function setup_endpoint() {
		...
		\MyListing\Src\Dashboard_Pages::instance()->add_page( [
			...
			'template' => locate_template( 'includes/extensions/promotions/templates/dashboard.php' ),
			'show_in_menu' => true,
			'order' => 3,
		] );
	}
	...
	public function get_promotions_modal() {
		...
		return require locate_template( 'includes/extensions/promotions/templates/choose-promotion.php' );
	}

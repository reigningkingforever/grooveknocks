...
class Mapbox {
	...
	public function enqueue_scripts() {
		// Styles.
		wp_enqueue_style( 'mylisting-maps', c27()->template_uri( 'assets/dist/maps/mapbox/mapbox.css' ), [], CASE27_THEME_VERSION );

		// Scripts.
		wp_enqueue_script( 'mapbox-gl', 'https://api.tiles.mapbox.com/mapbox-gl-js/v0.47.0/mapbox-gl.js', [], null, true );
	...
	public function show_get_directions_link( $place ) {
		...
		printf(
			...
			__( 'Get Directions', 'Map Block', 'my-listing' )
		);
	}
}
...
<div
    ...
    <div class="lf-item">
        <a href="<?php echo esc_url( $listing->get_link() ) ?>">
            ...
            <div class="lf-head">
                <?php if ( $isPromoted ): ?>
                    <div class="lf-head-btn ad-badge" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo esc_attr( $promotion_tooltip ) ?>">
                ...
                <?php if ($options['buttons']): ?>
                    ...
                    <?php foreach ($options['buttons'] as $button): ?>
                        ...
                        <?php if ( $button['show_field'] == '__listing_rating' ): ?>
                            <?php if ( $listing_rating = MyListing\Ext\Reviews\Reviews::get_listing_rating_optimized($listing->get_id()) ): ?>
                                <div class="lf-head-btn listing-rating">
                                    <span class="value"><?php echo esc_html( $listing_rating ) ?></span>
                                    <sup class="out-of">/<?php echo MyListing\Ext\Reviews\Reviews::max_rating( $listing->get_id() ); ?></sup>
                                </div>
                            <?php endif ?>

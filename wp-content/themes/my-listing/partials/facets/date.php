    ...
    <?php else: ?>
        <?php if ($data['options']['type'] == 'range'):
            ...
            <div class="form-group explore-filter double-input date-input">
                <label><?php echo esc_html( $data['facet']['label'] ) ?></label>
                <input type="hidden" name="<?php echo esc_attr( "{$data['facet']['url_key']}_from" ) ?>" id="<?php echo esc_attr( $fromID ) ?>">
                <input type="hidden" name="<?php echo esc_attr( "{$data['facet']['url_key']}_to" ) ?>" id="<?php echo esc_attr( $toID ) ?>">
        ...
        <?php if ($data['options']['type'] == 'exact'):
            ...
            <div class="form-group explore-filter date-input">
                <label><?php echo esc_html( $data['facet']['label'] ) ?></label>
                <input type="hidden" name="<?php echo esc_attr( $data['facet']['url_key'] ) ?>" id="<?php echo esc_attr( $inputID ) ?>">
